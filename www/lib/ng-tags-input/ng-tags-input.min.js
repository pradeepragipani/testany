        ...
        return {
            ...
            controller: ["$scope", "$attrs", "$element", function(a, c, d) {
                a.events = h.simplePubSub(), g.load("tagsInput", a, c, {
                    ...
                    type: [String, "text", j],
                    placeholder: [String, "Please add one or more Tag(optional)"],
